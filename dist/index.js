...
const { WError } = __nccwpck_require__( 809 );
...
const core = __nccwpck_require__( 320 );
const { SError } = __nccwpck_require__( 809 );
const picomatch = __nccwpck_require__( 754 );
const fetchTeamMembers = __nccwpck_require__( 11 );
...
const core = __nccwpck_require__( 320 );
const yaml = __nccwpck_require__( 419 );
const reporter = __nccwpck_require__( 418 );
const Requirement = __nccwpck_require__( 71 );
...
async function main() {
	try {
		...
		const reviewers = await __nccwpck_require__( 581 )();
		core.startGroup( `Found ${ reviewers.length } reviewer(s)` );
		reviewers.forEach( r => core.info( r ) );
		core.endGroup();

		const paths = await __nccwpck_require__( 486 )();
